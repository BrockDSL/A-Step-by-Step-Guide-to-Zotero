...
In preparation for this module, you will need to register for a [Zotero account](https://www.zotero.org/user/register). Download the [desktop client](https://www.zotero.org/support/installation) and [browser extension](https://www.zotero.org/download/). Once Zotero is installed, check and see if the plugin for your word processor (like LibreOffice or MS Word) was automatically set up by opening the program and looking for the Zotero tab at the top of the screen. If not then follow the [install plugins](https://www.zotero.org/support/word_processor_plugin_manual_installation) instructions for your word processors, like LibreOffice or MS Word.
